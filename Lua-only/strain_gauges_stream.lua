--[[
    ...
    Note: Streams at 1KS/s, using nominal cal constants
...
MB.writeName("STREAM_NUM_ADDRESSES", 2) -- Use 1 channel for streaming
MB.writeName("STREAM_SETTLING_US", 0) -- settling time
MB.writeName("STREAM_RESOLUTION_INDEX", 8) -- stream resolution (1-8)
...
MB.writeName("STREAM_NUM_SCANS", 0) -- Run continuously

MB.writeName("AIN0_NEGATIVE_CH", 1) --set negative channel
MB.writeName("STREAM_SCANLIST_ADDRESS0", 0) -- Scan AIN0

MB.writeName("AIN0_NEGATIVE_CH", 199) --set negative channel to ground
MB.writeName("STREAM_SCANLIST_ADDRESS1", 2) -- Scan AIN2
MB.W(4018, 0, 0)
